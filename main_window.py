...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, candidate_list):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(115, 110, 441, 291))
        ...
        self.pushButton.setGeometry(QtCore.QRect(260, 420, 120, 40))
...
###
 ...
 #####
    ...
    def enter_voter_id_msg(self):
        msg = QMessageBox()
        msg.setWindowTitle("Error !!")
        msg.setText("Please enter your voter id")
        msg.setIcon(QMessageBox.Warning)

        x = msg.exec_()

    def already_voted_msg(self):
        msg = QMessageBox()
        msg.setWindowTitle("Error !!")
        msg.setText("Sorry, You have already voted!!")
